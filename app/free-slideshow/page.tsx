...
import { FreeSlideshowForm } from '@/components/free-slideshow/FreeSlideshowForm';
import { Toaster } from '@/components/ui/sonner';

export const metadata = {
  title: 'Generate Free Real Estate Slideshow | Media Portal',
  description:
    'Upload your photos, add your details, and we will automatically generate a 1920x1080 slideshow for you. We will email you when it is ready.',
};

export default function FreeSlideshowPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Header (match booking / free tools pages) */}
      ...
      <main className="mx-auto max-w-5xl p-6 md:p-8 space-y-6">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-semibold">Free Slideshow</h1>
          <p className="mt-1 text-sm md:text-base text-gray-600">
            Upload 6 photos, add your details, and we will automatically generate
            a 1920x1080 property slideshow for you. We&rsquo;ll email you when it is
            ready.
          </p>
        </div>
