...
import { FreeSlideshowLeadClient } from '@/components/free-slideshow/FreeSlideshowLeadClient';

export default async function FreeSlideshowLeadPage({
  params,
}: {
