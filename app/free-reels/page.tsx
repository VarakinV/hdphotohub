...
import { FreeReelsForm } from '@/components/free-reels/FreeReelsForm';
import { Toaster } from '@/components/ui/sonner';

export const metadata = {
  title: 'Generate Free Real Estate Reels | Media Portal',
  description:
    'Upload your photos, add your details, and we will automatically generate social reels for you. We will email you when they are ready.',
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-5xl p-6 md:p-8 space-y-6">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-semibold">Free Reels</h1>
          <p className="mt-1 text-sm md:text-base text-gray-600">
            Upload your photos, add your details, and we will automatically
            generate social reels for you. We’ll email you when they are ready.
          </p>
        </div>
